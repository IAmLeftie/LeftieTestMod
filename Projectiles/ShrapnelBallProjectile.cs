...
{
    public class ShrapnelBallProjectile : ModProjectile
    {
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Shrapnel Ball");
        ...
        public override void Kill(int timeLeft)
		{
			...
			//Create a Vector2 holding the launch velocity of the new shrapnel projectiles
			Vector2 launchVelocity = new Vector2(-2.25f, 0);
			...
			for (int i = 0; i < 5; i++)
			{
				...
				Projectile.NewProjectile(Projectile.InheritSource(Projectile), Projectile.Center, launchVelocity,
					ModContent.ProjectileType<ShrapnelProjectile>(), Projectile.damage / 2, Projectile.knockBack / 3, Projectile.owner);
			}
		}
